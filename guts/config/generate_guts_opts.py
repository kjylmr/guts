...
"""
    ...
    license_str = textwrap.dedent(lic_str)
    ...
    for atree in dir_trees_list:
        ...
        if atree in ["guts/config/generate_guts_opts.py",
                     "guts/hacking/checks.py", ]:
            # TODO(Bharat): Add migration/configration.py file
            # "guts/migration/configuration.py", ]:
            continue
    ...
    for key in opt_dict:
        ...
        for aline in afile:
            ...
            if exists != -1:
                ...
                if (exists != -1) or (key == 'guts_migration_configuration'):
                    continue

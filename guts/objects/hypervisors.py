...
class Hypervisor(base.GutsPersistentObject, base.GutsObject,
    ...
    fields = {
        ...
        'allowed_hosts': fields.StringField(nullable=True),
        'exclude_resource_uuids': fields.StringField(nullable=True),
        'exclude_resource_names': fields.StringField(nullable=True),
...
class HypervisorList(base.ObjectListBase, base.GutsObject):
    ...
    def get_all(cls, context, filters=None, marker=None, limit=None,
        ...
        filters.pop('all_tenants', 0)
        hypervisors = db.hypervisor_get_all(context, filters, marker, limit,
    ...
    def get_all_by_host(cls, context, host, filters=None):
        hypervisors = db.hypervisor_get_all_by_host(context, host, filters)
        return base.obj_make_list(context, cls(context), objects.Hypervisor,
                                  hypervisors)
